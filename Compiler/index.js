  ...
  try {
    ...
    switch (language) {
      ...
      case "java":
        ...
        break;
      case "python":
      case "py": // 🟢 just in case 'py' is passed
    ...
    console.error("❌ Internal error during execution:");
    ...
    return res.status(500).json({
      success: false,
      output: "",
      error: error.stderr || error.message || error.toString() || "Internal execution error",
    });
  }
});
